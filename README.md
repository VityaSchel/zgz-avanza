...
|         | 2                                              | [00-01] always `4245` (`BE` in ASCII)<br>[02-04] Zaragoza card ID number (together forming `BE` + number)<br>[05-14] empty, zeroed<br>[15] unknown card-specific constant                                                                                                           | `4245..,,..00000000000000000000..` | Read-only            |
