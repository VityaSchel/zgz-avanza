...
|         | 2                                              | [00-01] always `4245` (`BE` in ASCII)<br>[02-04] Zaragoza card ID number (together forming `BE` + number)<br>[05-14] empty, zeroed<br>[15] XOR of all previous bytes                                                                                                                | `4245..,,..00000000000000000000..` | Read-only            |
...
|         | 5                                              | Empty if new card<br>[00-02] always `020002`<br>[03-04] unknown card-specific constant<br>[05-06] unknown<br>[07] integer<br>[08] either 01 or 02<br>[09-11] unknown<br>[12] BCD-encoded hour (0-23)<br>[13] BCD-encoded minute<br>[14] BCD-encoded second<br>[15] sequence counter | `020002..,,..,,..,,..,,..,,..,,..` | No restrictions      |
...
|         | 10                                             | Empty if new card, correlates to block 5 (see [Blocks 5 and 10](#blocks-5-and-10))<br>[00-01] unknown<br>[02-05] same as [10-13] in block 5<br>[06-08] always `010200`<br>[09-10] same as [07-08] in block 5<br>[11-14] always `00006300`<br>[15]  XOR of all previous bytes        | `..,,..,,..,,010200..,,00006300..` | No restrictions      |
