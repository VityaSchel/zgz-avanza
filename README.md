...
| 3       | 12                     | Empty on top up cards<br>[00-14] unknown<br>[15] XOR of all previous bytes                                                                                                                                                                                                                                                                           | `00000000000000000000000000000000` | Only Key B can write |
|         | 13                     | Empty on top up cards<br>[00-14] unknown; could be validity date<br>[15] XOR of all previous bytes                                                                                                                                                                                                                                                   | `00000000000000000000000000000000` | Only Key B can write |
|         | 14                     | Same as block 13                                                                                                                                                                                                                                                                                                                                     | `00000000000000000000000000000000` | Only Key B can write |
| 4       | 16                     | Empty on top up cards<br>[00-14] unknown<br>[15] XOR of all previous bytes                                                                                                                                                                                                                                                                           | `00000000000000000000000000000000` | Only Key B can write |
|         | 17                     | Empty on top up cards<br>[00-14] unknown; could be validity date<br>[15] XOR of all previous bytes                                                                                                                                                                                                                                                   | `00000000000000000000000000000000` | Only Key B can write |
|         | 18                     | Same as block 17                                                                                                                                                                                                                                                                                                                                     | `00000000000000000000000000000000` | Only Key B can write |
| 3,4,5,6 | 20, 21, 22, 24, 25, 26 | Empty                                                                                                                                                                                                                                                                                                                                                | `00000000000000000000000000000000` | Only Key B can write |
